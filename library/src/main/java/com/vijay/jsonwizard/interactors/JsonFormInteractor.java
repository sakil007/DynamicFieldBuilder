...
import com.vijay.jsonwizard.widgets.EditTextDatePickerFactory;
...
public class JsonFormInteractor {
    ...
    private void registerWidgets() {
        ...
        map.put(JsonFormConstants.CHOOSE_DATEPICKER, new EditTextDatePickerFactory());
        map.put(JsonFormConstants.CHOOSE_TIMEPICKER, new EditTextDatePickerFactory());
